[![Run App NicholasWitulski](https://github.com/NWitulski2/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/NWitulski2/GithubActions/actions/workflows/run-app.yaml)
